...
CREATE TABLE semana (
	...
	lista_encerrada BOOLEAN, 
	draft_em_andamento BOOLEAN, 
	draft_finalizado BOOLEAN, 
	max_times INTEGER, 
	max_jogadores_por_time INTEGER, 
	tempo_escolha INTEGER, 
...
CREATE TABLE configuracao_global (
	...
	duracao_mensalidade_dias INTEGER, 
